...
class ApiApi {
  ...
  Future<Response<void>> destroyGroup(
    ...
    final _request = RequestOptions(
      path: r'/api/groups/{id}'.replaceAll('{' r'id' '}', id.toString()),
      method: 'DELETE',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<void>> destroyUser(
    ...
    final _request = RequestOptions(
      path: r'/api/users/{id}'.replaceAll('{' r'id' '}', id.toString()),
      method: 'DELETE',
      headers: <String, dynamic>{
        ...?headers,
      },
  ...
  Future<Response<Channel>> retrieveChannel(
    ...
    final _request = RequestOptions(
      path: r'/api/channels/{channel_id}'.replaceAll('{' r'channel_id' '}', channelId.toString()),
      method: 'GET',
      headers: <String, dynamic>{
        ...?headers,
      },
