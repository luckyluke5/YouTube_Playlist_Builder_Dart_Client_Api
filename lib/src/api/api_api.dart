...
import 'package:my_api/src/model/inline_response200.dart';
import 'package:my_api/src/model/inline_response2001.dart';
import 'package:my_api/src/model/inline_response2002.dart';
import 'package:my_api/src/model/inline_response2003.dart';
...
class ApiApi {
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> destroyGroup({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> destroyUser({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2002>> listChannels({ 
    int? page,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2003>> listFollows({ 
    int? page,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2001>> listGroups({ 
    int? page,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse200>> listUsers({ 
    int? page,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Group] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Group>> partialUpdateGroup({ 
    required String id,
    Group? group,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  ///
  /// Parameters:
  /// * [channelId] - A unique value identifying this channel.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Channel>> retrieveChannel({ 
    ...
    final _path = r'/api/channels/{channel_id}'.replaceAll('{' r'channel_id' '}', channelId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Group] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Group>> retrieveGroup({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
